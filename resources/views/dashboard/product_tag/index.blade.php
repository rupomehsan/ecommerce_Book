                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-3">
                                        <a href="{{route('dashboard.product_tag.edit',$item->id)}}" class="btn btn-sm btn-outline-info"> Edit </a>
                                        <a href="{{route('dashboard.product_tag.destory',$item->id)}}" class="btn btn-sm btn-outline-danger"> delete </a></div>
                                </td>
                            </tr>
                            @endforeach
