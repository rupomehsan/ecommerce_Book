<div class="page-main-header">
    ...
    <div class="main-header-left" semilight-bg-color="bg-default-light-colo">
        <div class="logo-wrapper">
            <a href="/dashboard" id="logo" class="d-flex align-items-end gap-1">
                {{-- <img src="/assets/backend/logo.png" class="image-dark" alt="" />
                    <img src="/assets/backend/logo.png" class="image-light" alt="" /> --}}
    ...
    <div class="main-header-right row" header-bg-color="bg-default-light-colo">
        <div class="mobile-sidebar col-1 ps-0">
            <div class="text-start switch-sm">
                <label class="switch">
                    <input type="checkbox"
                        onchange="page_body_wrapper.classList.toggle('sidebar-close')"
                        id="sidebar-toggle" checked="checked" />
