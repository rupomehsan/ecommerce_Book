...
@section('content')
    <div class="container-fluid" style="margin-top: 100px;">
        <form action="{{ route('dashboard.banner.update',$editdata->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-md-6">
                        <label for=""> url </label>
                        <div class="mt-1 mb-3"><input type="text" value="{{$editdata->redirect_url}}"  name="url" class="form-control mb-1" /></div>
                    </div>
