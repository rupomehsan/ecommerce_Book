        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="mt-1 mb-3"><input type="number" name="role_serial" class="form-control mb-1" /></div>
                </div>
            </div>

            <div class="card-header py-2 position-sticky d-flex justify-content-start"><button type="submit" class="btn btn-info btn-sm">Create</button></div>
        </div>
    </form>
</div>
@endsection
