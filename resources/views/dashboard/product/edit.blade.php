...
<div layout_title="Product Management">
    ...
    <div class="container">
        <div class="card list_card">
            ...
            <form action="{{route('dashboard.product.update',$data->id)}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-body">
                            ...
                            <div class="admin_form form_1 d-grid">
                                <div class="form-group full_width d-grid align-content-start gap-1 mb-2">
                                    <div class="field_wrapper">
                                        <label class="text-capitalize d-block">
                                            ...
                                            <input onkeyup="createUrl(event.target.value)" type="text" value="{{ old('product_name') ?? $data->product_name }}" name="product_name" class="form-control" />
                                        </label>
                                        @error('product_name')
                                ...
                                <div class="form-group full_width d-grid align-content-start gap-1 mb-2">
                                    <div class="field_wrapper">
                                        <label class="text-capitalize d-block">
                                            ...
                                            <input type="text" value="{{ old('product_url') ?? $data->product_url }}" id="product_url" name="product_url" class="form-control" />
                                        </label>
                                        @error('product_url')
                                            <div class="text-warning my-1">
                                                {{ $message }}
                                ...
                                <div class="full_width row">
                                    ...
                                    <div class="form-group d-grid col-lg-4 align-content-start gap-1 mb-2">
                                        <div class="field_wrapper">
                                            <label for="sales_price" class="text-capitalize d-block">
                                                ...
                                                <input type="text" value="{{ old('sales_price') ?? $data->sales_price }}" id="sales_price" name="sales_price" class="form-control" />
                                            </label>
                                            @error('sales_price')
                                                <div class="text-warning my-1">
                                                    {{ $message }}
                                    ...
                                    <div class="form-group d-grid col-lg-4 align-content-start gap-1 mb-2">
                                        <div class="field_wrapper">
                                            <label for="stock" class="text-capitalize d-block">
                                                ...
                                                <input type="text" value="{{ old('stock') ?? $data->stock }}" name="stock" class="form-control" />
                                            </label>
                                            @error('stock')
                                                <div class="text-warning my-1">
                                                    {{ $message }}
                                    ...
                                    <div class="form-group d-grid col-lg-4 align-content-start gap-1 mb-2">
                                        <div class="field_wrapper">
                                            <label for="low_stock" class="text-capitalize d-block">
                                                ...
                                                <input type="text" value="{{  old('low_stock') ?? $data->low_stock  }}" id="low_stock" name="low_stock" class="form-control" />
                                            </label>
                                            @error('low_stock')
                                                <div class="text-warning my-1">
                                                    {{ $message }}
                                        ...
                                        <div>
                                            ...
                                            <select name="selected_categories" id="selected_categories" class="form-control">
                                                @foreach ( $product_categories as $product_catagory)
                                                    <option {{ $data->selected_categories == $product_catagory->id ? 'selected':'' }}
                                                        value="{{$product_catagory->id}}">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="field_wrapper">
                                                <label class="text-capitalize d-block">
                                                    ...
                                                    <div>
                                                        <img src="/{{$data->image}}" id="preview_image" style="max-height: 100px;" class="img-thumbnail" alt="">
                                                    </div>
                                                </label>
                                                @error('image')
                                                    <div class="text-warning my-1">
                                    ...
                                    <div class="form-group d-grid align-content-start full_width  gap-1 mb-2 ">
                                        ...
                                        @enderror
                                        <textarea id="short_description" name="short_description">{{ old('short_description') ?? $data->short_description }}</textarea>
                                    </div>
                                            ...
                                            <div class="form-group d-grid align-content-start gap-1 mb-2">
                                                <div class="field_wrapper">
                                                    <label for="meta_title" class="text-capitalize d-block">
                                                        ...
                                                        <input type="text" id="meta_title" value="{{ old('meta_title') ?? $data->meta_title  }}" name="meta_title" class="form-control" />
                                                    </label>
                                                    @error('meta_title')
                                                        <div class="text-warning my-1">
                                                            {{ $message }}
                                            ...
                                            <div class="form-group d-grid align-content-start gap-1 mb-2">
                                                <div class="field_wrapper">
                                                    <label for="meta_keywords" class="text-capitalize d-block">
                                                        ...
                                                        <input type="text" id="meta_keywords" value="{{ old('meta_keywords') ?? $data->meta_keywords }}" name="meta_keywords" class="form-control" />
                                                    </label>
                                                    @error('meta_keywords')
                                                        <div class="text-warning my-1">
                                                            {{ $message }}
                                            ...
                                            <div class="form-group d-grid align-content-start gap-1 mb-2">
                                                <div class="field_wrapper">
                                                    <label for="page_title" class="text-capitalize d-block">
                                                        ...
                                                        <textarea type="text" id="meta_description" name="meta_description" class="form-control">{{ old('meta_description') ?? $data->meta_description }}</textarea>
                                                    </label>
                                            ...
                                            <div class="form-group d-grid align-content-start gap-1 mb-2">
                                                <div class="field_wrapper">
                                                    <label class="text-capitalize d-block">
                                                        ...
                                                        <input type="text" name="video_url" value="{{ old('video_url') ?? $data->video_url }}" class="form-control" />
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group d-grid align-content-start gap-1 mb-2">
                                                <div class="field_wrapper">
                                                    <label class="text-capitalize d-block">
                                                        ...
                                                        <textarea type="text" name="schema_tag" value="{{ old('schema_tag') ?? $data->schema_tag }}" class="form-control" ></textarea>
                                                    </label>
                                                </div>
                                            </div>
